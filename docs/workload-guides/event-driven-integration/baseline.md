...
content_validation:
  ...
  reviewer: agent
  core_claims:
  - claim: Document covers Event-Driven Integration Baseline aligned with Azure architecture
      guidance
  ...
  - claim: Document includes Microsoft Learn-traceable guidance for Event-Driven Integration
    ...
    verified: false
  - claim: Document addresses Recommended baseline for Event-Driven Integration Baseline
    source: https://learn.microsoft.com/en-us/azure/azure-functions/functions-scale
    verified: false
  - claim: Document addresses Canonical reference architecture for Event-Driven Integration
      Baseline
    source: https://learn.microsoft.com/en-us/azure/container-apps/overview
    verified: false
  - claim: Document addresses Service composition for Event-Driven Integration Baseline
