...
content_validation:
  ...
  reviewer: agent
  core_claims:
  - claim: Document covers Event-Driven Architecture aligned with Azure architecture
      guidance
    source: https://learn.microsoft.com/en-us/azure/architecture/guide/architecture-styles/event-driven
    verified: false
  - claim: Document includes Microsoft Learn-traceable guidance for Event-Driven Architecture
    source: https://learn.microsoft.com/en-us/azure/architecture/guide/architecture-styles/event-driven
    verified: false
  - claim: Document addresses Fundamentals for Event-Driven Architecture
    source: https://learn.microsoft.com/en-us/azure/architecture/guide/architecture-styles/event-driven
    verified: false
  - claim: Document addresses Why teams adopt event-driven architecture for Event-Driven
      Architecture
    source: https://learn.microsoft.com/en-us/azure/architecture/guide/architecture-styles/event-driven
    verified: false
  - claim: Document addresses Azure service selection for Event-Driven Architecture
    source: https://learn.microsoft.com/en-us/azure/architecture/guide/architecture-styles/event-driven
    verified: false
---
