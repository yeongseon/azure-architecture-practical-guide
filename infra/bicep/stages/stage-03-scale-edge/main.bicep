...
@description('Azure region for all Stage 3 resources.')
...
module responseTimeAlert '../../modules/foundation/metric-alerts.bicep' = {
  name: 'stage03-responsetime-alert'
  params: {
